...
<div class="flex flex-col gap-4">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('reports.pdf', $event->id) }}" target="_blank" class="flex items-center gap-1.5 text-[10px] font-bold bg-brand-accent text-white px-3 py-1.5 rounded-lg hover:bg-brand-gold transition-all active:scale-95">
