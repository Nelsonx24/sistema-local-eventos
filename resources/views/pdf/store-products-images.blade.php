...
<head>
    <meta charset="utf-8">
    <title>Productos con Imágenes - Tienda</title>
    <style>
...
<body>
    <h1>Productos con Imágenes - Tienda</h1>
    ...
    <div class="grid">
        ...
        <div class="card">
            ...
            <img src="{{ public_path('storage/'.$product->image) }}" alt="">
            @else
    ...
    <p class="subtitle">Total: {{ $products->count() }} productos</p>
