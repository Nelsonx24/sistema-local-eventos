...
<div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <a href="{{ route('others.qr') }}" class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-brand-accent transition-all text-left flex flex-col gap-4 group">
    ...
    <a href="{{ route('others.contract-settings') }}" class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-brand-accent transition-all text-left flex flex-col gap-4 group">
        <div class="w-14 h-14 bg-brand-gold/10 text-brand-gold rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
    ...
    <a href="{{ route('others.notifications') }}" class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-brand-accent transition-all text-left flex flex-col gap-4 group">
        <div class="w-14 h-14 bg-brand-gold/10 text-brand-gold rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
    ...
    <a href="{{ route('settings.index') }}" class="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-brand-accent transition-all text-left flex flex-col gap-4 group">
        <div class="w-14 h-14 bg-brand-gold/10 text-brand-gold rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <div>
            <h3 class="text-lg font-black text-slate-900 tracking-tight">Configuración</h3>
            <p class="text-sm text-slate-500 mt-1">Ajustes generales del sistema y preferencias.</p>
        </div>
    </a>
</div>
@endsection
