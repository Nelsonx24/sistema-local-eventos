    ...
    <div class="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-6">
        <form method="POST" action="{{ route('others.contract-settings.update') }}">
            ...
            <div class="p-4 bg-slate-50 border border-slate-100 rounded-2xl flex gap-3 items-start mt-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-indigo-500 shrink-0 mt-0.5"><circle cx="12" cy="12" r="10"/><line x1="12" x2="12" y1="8" y2="12"/><line x1="12" x2="12.01" y1="16" y2="16"/></svg>
            ...
            <button type="submit" class="mt-6 px-8 py-3 rounded-2xl font-bold flex items-center gap-2 transition-all shadow-xl bg-indigo-600 text-white shadow-indigo-200 hover:bg-indigo-700">
