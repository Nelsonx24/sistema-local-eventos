                    ...
                    <tbody class="divide-y divide-[#f1f5f9]">
                        ...
                        <tr class="hover:bg-[#f8fafc] transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <span class="text-[0.75rem] text-text-muted font-mono font-bold">Bs.{{ number_format($product->cost, 2) }}</span>
                            </td>
                            <td class="px-6 py-4 text-right">
                                <span class="text-[0.75rem] font-bold text-brand-accent font-mono">Bs.{{ number_format($product->sale_price, 2) }}</span>
                            </td>
